...
cwd = os.getcwd() 
# data_path = join(cwd,'miniimagenet/all_folder')
data_path = '/home/jiechao_guan/Desktop/python/pytorch/2020/icml2020/datasets/ILSVRC/Data/CLS-LOC/train'
savedir = './'
...
for dataset in dataset_list:    
    with open(datasetmap[dataset] + ".csv", "r") as lines:
        for i, line in enumerate(lines):
            ...
            # fname = join(data_path,label, fnames)
