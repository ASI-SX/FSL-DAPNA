...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='MiniImageNet', choices=['MiniImageNet', 'CUB', 'TieredImageNet','cross'])
    # parser.add_argument('--init_weights', type = str, default= None)
    parser.add_argument('--init_weights', type = str, default="./saves/mini_wideresnet28_best.pth.tar")  
    # parser.add_argument('--init_weights', type = str, default="./saves/cub_wideresnet28_best.pth.tar") 
    # parser.add_argument('--init_weights', type = str, default="./saves/tiered_wideresnet28_best.pth.tar")
    ...
    log(val_log_file_path, 'Test Acc {:.4f} + {:.4f}'.format(m, pm))      
